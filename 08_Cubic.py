...
# func_root_ReX_cmp = []
# func_root_ImX_cmp = []
# 5 starting points per quadrant, per each seg_range(= radius of circle)
# N_start_pnts = 20
# seg_range = 1
N_roots = 1
n_roots = 0
...
while n_roots < N_roots:
    ...
    while not achieved_func_accuracy:
        ...
        if math.fabs(func_val1 - func_val2) > math.pow(10, -func_accuracy):
            ...
            if min(round(func_val2, func_accuracy), round(func_val1, func_accuracy)) < 10 * math.pow(10, -func_accuracy):
